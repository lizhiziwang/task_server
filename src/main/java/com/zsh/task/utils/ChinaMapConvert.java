...
public class ChinaMapConvert {
     ...
     * @param lat
     */
    public static double[] transformTo3857(double lon,double lat){
        double x = lon * mercatorMax/180;
     ...
     * @param mercatory
     */
    public static double[] tarnsformTo4326(double mercatorx,double mercatory){
